      ...
      >
        ...
        >
          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden" style={{ overflow: 'hidden' }}>
            {/* Video Section */}
            <div ref={videoRef} className="mb-4 bg-white rounded-lg shadow-lg overflow-hidden border-2 border-white flex-shrink-0">
              <div className="relative w-full bg-black rounded-lg" style={{ paddingBottom: '50%' }}>
                {shouldLoadVideo ? (
                  <iframe
