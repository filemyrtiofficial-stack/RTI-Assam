...
const services: Service[] = [
  {
    ...
    icon: SOFIcon,
    description: 'RTI for land records, mutation status, land conversion, Circle Office records.',
  ...
  },
  {
    ...
    icon: AnonyIcon,
    description: 'RTI for property tax, building plan approvals, trade licenses, civic services.',
    route: '/services/custom-rti',
  },
  {
    id: '3',
    name: 'Police Department (Assam Police)',
    icon: FirstIcon,
  ...
  },
  {
    ...
    icon: SOFIcon,
    description: 'RTI for Assam Housing & Urban Affairs Department sites, layout approvals, project status.',
    route: '/services/custom-rti',
  },
  {
    id: '8',
...
export const AssamServicesGrid: React.FC = () => {
      ...
      <div className="container-responsive max-w-7xl mx-auto px-4">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-[32px] sm:text-[36px] md:text-[40px] font-semibold text-gray-900 mb-4">
            Popular RTI Services in Assam
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Expert RTI drafting and filing for all Assam government departments
          </p>
        </div>
